...
<p align="center">
  ...
  <a href="#research-curation">Research curation</a> ·
...
- **Own the corpus.** Every concept, comparison, and source capture lives under `data/wiki/` and remains useful without this application.
...
The repository currently includes detailed, primary-source-backed analysis of:

- Feature configuration and remote configuration
- OpenFeature’s vendor-neutral evaluation/provider model
- Unleash, Flagsmith, GrowthBook, Flipt, and OpenFlagr
- LINE Central Dogma and LINE Flagship SDKs
- Spring Cloud Config, Togglz, and FF4J
- `django-waffle`, `django-flags`, and Dynaconf

A Hermes scheduled curation job can add one deeply researched Spring/JVM project at a time. Its discipline is intentionally strict: primary sources only, explicit version/edition boundaries, an immutable source capture when appropriate, derived-index verification, and no mixing with unrelated working-tree changes.
