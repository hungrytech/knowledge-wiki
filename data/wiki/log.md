...
* **Spring OSS curation**: Added [Spring AMQP](/concepts/spring-amqp.md) and an immutable [official README capture](/sources/spring-amqp-readme-2026-07-11.md) pinned by SHA-256 and upstream commit. The Concept records template, listener-container, topology-administration, Spring Boot, broker-operation, payload-security, delivery-semantics, and compatibility boundaries; the [Spring OSS ecosystem catalog](/concepts/spring-oss-ecosystem.md) now marks the verified project curated.
