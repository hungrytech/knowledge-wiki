...
- **지식의 소유권:** 개념·비교·원문 캡처는 로컬 `data/wiki/`에 보관합니다. 저장소에는 개인 지식 문서를 의도적으로 포함하지 않습니다.
...
> 이 저장소에는 개인 지식 문서가 포함되지 않습니다. 설치 후 로컬 `data/wiki/`에 문서를 만들면 Git이 무시하므로 이 기기에만 남습니다.
